...
import com.transapi.documents.B2C_C2B_Entries;
import com.transapi.transactionapi.dtos.*;
import com.transapi.transactionapi.repository.B2CC2BEntriesRepository;
import com.transapi.transactionapi.repository.StkPushEntriesRepository;
...
public class MpesaController {
    ...
    public MpesaController(TransacApi transacApi, AcknowledgeResponse acknowledgeResponse, ObjectMapper objectMapper, StkPushEntriesRepository stkPushEntriesRepository, B2CC2BEntriesRepository b2CC2BEntriesRepository) {
    ...
    public ResponseEntity<SimulateTransactionResponse> simulateB2CTransaction(@RequestBody SimulateTransactionRequest simulateTransactionRequest) {
        ...
        SimulateTransactionResponse simulateTransactionResponse = transacApi.simulateC2BTransaction(simulateTransactionRequest);
    ...
    public ResponseEntity<CommonSyncResponse> performB2CTransaction(@RequestBody InternalB2CTransactionRequest internalB2CTransactionRequest) {
        CommonSyncResponse commonSyncResponse = transacApi.performB2CTransaction(internalB2CTransactionRequest);
    ...
    public ResponseEntity<CommonSyncResponse> checkAccountBalance() {
        return ResponseEntity.ok(transacApi.checkAccountBalance());
    }
    ...
    public ResponseEntity<StkPushSyncResponse> performStkPushTransaction(@RequestBody InternalStkPushRequest internalStkPushRequest) {
        return ResponseEntity.ok(transacApi.performStkPushTransaction(internalStkPushRequest));
    }
    ...
    public ResponseEntity<LNMQueryResponse> getTransactionStatus(@RequestBody InternalLNMRequest internalLNMRequest) {
        return ResponseEntity.ok(transacApi.getTransactionStatus(internalLNMRequest));
    }
}
